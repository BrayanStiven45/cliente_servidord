# Esta Prueba lo que hace es multiproccesing enviando en cada epoca los datos que 
# debe usar para entrenar la red
# conclucion: no es muy buena
...
# =========================================================
# FUNCIÓN PARALELA (FUERA DE LA CLASE)
# =========================================================
...
if __name__ == "__main__":
    ...
    model1 = CBNN(x_train, y_train, 25, 50, lr=0.05, n_batches=5)
    model1.training_parallel(n_processes=2)

    acc = evaluate_accuracy(model1, x_test, y_test)
